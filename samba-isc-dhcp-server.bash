...
#В Debian встречатся баг, из-за которого после однократного перезапуска этой службы адрес обновляется, однако вывод ifconfig некорректен - проблема решается двойным перезапуском службы
